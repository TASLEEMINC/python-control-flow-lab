...
def check_voting_eligibility():
    ...
    try:
        ...
        if age < 0 :
            print('Negative number enetered. Please enter a valid age.')
            return
        ...
        if age >= 18 :
            ...
            print(f"You are not old enough to vote. You need to be at least {voting_age} years old.")
...
def weather_advice():
    ...
    is_cold = input("Is it cold? Type your answer=>(yes/no): ").strip().lower()
    
    is_raining = input("Is it raining? Type your answer=>(yes/no): ").strip().lower()
...
# Call the function
# determine_season()                    6)ACTIVATE LATER